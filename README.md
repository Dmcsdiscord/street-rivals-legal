...
This Privacy Policy explains how [YOUR LEGAL NAME OR BUSINESS NAME] (“we,” “us,” or “our”) collects, uses, stores, and protects information when you use Street Rivals (the “Game” or “Service”) on Discord.
...
Official Discord hub: [YOUR HUB INVITE LINK] (Server ID: 1511056773048438973)

For privacy requests, data deletion, or questions: email us or open a Support ticket on the hub via the bot’s ticket panel.
...
It also applies when you use the bot on community servers that install Street Rivals, but those servers have their own moderators and rules. Discord itself processes data under Discord’s Privacy Policy.
...
Interactions, joins, races



Link your Game account to you
...
Interactions, member events



Show names in races, leaderboards, welcomes
...
Commands, races, lobbies



Run races in the correct place
...
Member data on our hub



Assign Street Rank roles; verify server booster perks
...
Race status phrases (active races only)
...
No system is 100% secure. Report suspected issues to [YOUR SUPPORT EMAIL].
...
Game account (players.json)



While you use the Service, or until you request deletion
...
Active during events; cleared when races end





Race result button snapshots
...
Ticket metadata & transcripts



As needed for support; deleted on request where possible
...
Rolling backups per host policy (may persist briefly after deletion)
...
Email: [YOUR SUPPORT EMAIL] — include your Discord username and user ID if possible



Support ticket: Hub server → ticket panel → Support
...
Street Rivals is not directed at children under 13. We do not knowingly collect data from anyone under 13. If you believe a child under 13 has provided data, contact us and we will delete it.



12. International Users

We operate from [YOUR COUNTRY]]. If you use the Service from other countries, your information may be processed in Canada or where our host stores data. By using the Service, you understand your data may cross borders.
...
Discord: [YOUR HUB INVITE LINK] — Support ticket via bot panel  



Street Rivals is an independent Discord application. This policy describes our practices only; Discord’s own Privacy Policy applies to Discord’s platform.
